...
import com.test.employeeservice.dto.OrganizationDTO;
import com.test.employeeservice.entities.Employee;
import com.test.employeeservice.mapper.EmployeeMapper;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDTO saveEmployee(EmployeeDTO dto) {
        ...
        EmployeeDTO dto1 = EmployeeMapper.maptoEmployeeDTO(savedEmployee);
        return dto1;
    }
    ...
    public APIResponseDTO getEmployeeByEmpid(Long empid) {
        ...
        OrganizationDTO organizationDTO = webClient.get()
                .uri("http://localhost:8083/api/organizations/" + e.getOrganizationCode())
                .retrieve()
                .bodyToMono(OrganizationDTO.class)
                .block();
        EmployeeDTO dto = EmployeeMapper.maptoEmployeeDTO(e);
